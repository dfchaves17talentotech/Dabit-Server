...
const getContinentsById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const collection = yield (0, mongo_connect_1.dbConnection)('continents');
        const document = yield collection.findOne({ _id: new mongodb_1.ObjectId(continentId) });
        return res.status(200).json(document);
    }
    catch (error) {
...
const deleteContinent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const continentId = req.params.id;
        const collection = yield (0, mongo_connect_1.dbConnection)('continents');
        const document = yield collection.deleteOne({ _id: new mongodb_1.ObjectId(continentId) });
        return res.status(200).json(document);
    }
    catch (error) {
